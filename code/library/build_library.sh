...
perl ~/projects/Clirc/bin/half2library.pl dm3_halves.txt dm3_circRNA.fa
...
perl ~/projects/Clirc/bin/index.pl ~/data/genomes/mm9/mm9_masked.fa mm9_index.txt
perl ~/projects/Clirc/bin/query.pl mm9_index.txt ~/data/genomes/mm9/mm9_masked.fa mm9_circRNA_coordinates.txt mm9_halves.txt 1
perl ~/projects/Clirc/bin/half2library.pl mm9_halves.txt mm9_circRNA.fa
